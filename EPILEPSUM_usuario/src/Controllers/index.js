...
index.verificacion = async (req, res, done) => {
	...
	if (traerDatosFamiliar.length == 0) {
		...
		if (familiar === undefined) {
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('MADRE')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('PADRE')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('HERMANO')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('HERMANA')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('TÍA')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('TÍO')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('ABUELO')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('ABUELA')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('PRIMO')"
			);
			await sql.query(
				"INSERT INTO familiares (nombreFamiliar) VALUES ('PRIMA')"
			);
